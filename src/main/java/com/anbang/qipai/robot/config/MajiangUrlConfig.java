...
public class MajiangUrlConfig {
    ...
    static {
        ...
        wenzhouMajiang.put("maidiInfo",bundle.getString("majiang.mj.maidiinfo"));
        ...
        ruianMajiang.put("maidiInfo",bundle.getString("majiang.mj.maidiinfo"));
        ...
        dianpaoMajiang.put("maidiInfo",bundle.getString("majiang.mj.maidiinfo"));
        ...
        fangpaoMajiang.put("maidiInfo",bundle.getString("majiang.mj.maidiinfo"));
